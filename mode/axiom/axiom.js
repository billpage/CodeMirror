...
(function(mod) {
  ...
  CodeMirror.registerHelper("hintWords", "axiom", commonKeywords.concat(commonBuiltins));

  function top(state) {
    return state.scopes[state.scopes.length - 1];
  }

  CodeMirror.defineMode("axiom", function(conf, parserConf) {
  ...
  CodeMirror.defineMIME("text/x-axiom", "axiom");
